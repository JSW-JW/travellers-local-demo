...
class UserProfileManager(BaseUserManager):
    ...
    def create_user(self, email, name, password=None): # Because of the way django password checking system works, it won't be able to authenticate until they set the password.
